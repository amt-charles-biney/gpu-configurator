...
public class CartController {
    ...
    @CrossOrigin
    @GetMapping("/v1/carts")
    public ResponseEntity<CartItemsResponse> getCartItems(Principal principal, HttpSession session) {
        return ResponseEntity.ok(cartService.getCartItems(principal, session));
    }
}
